...
public class OllamaAI extends BaseModule implements IGroupMessageEvent {
    ...
    public OllamaAI(BotWrapper botHelper) {
        super(botHelper);
    }
    ...
    public boolean onGroupMessage(final GroupMessageEvent event) {
        ...
        if (config == null || !config.isFunctionEnabled(Functions.OllamaAI)) {
            return false;
        }
        if (qqId == 2856986197L) {
