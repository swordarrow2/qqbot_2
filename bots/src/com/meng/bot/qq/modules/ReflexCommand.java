...
import com.meng.tools.normal.SignatureAnalyzer;
...
public class ReflexCommand extends BaseModule implements IGroupMessageEvent {
    ...
    public ReflexCommand(BotWrapper botHelper) {
        super(botHelper);
    }
    ...
    public String invoke(List<String> cmds) throws Exception {
        ...
        Object module = moduleManager.getModule(targetClass);
        ...
        return (signature.returnType == long.class ? JSON.toJson(result) : result.toString());
    }
