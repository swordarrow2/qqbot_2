...
public class TH07Data extends THGameData {
    ...
    private TH07Data() {
        ...
        spells = new THSpell[]{
            new THSpell(this, chara_琪露诺, "冻符「Freeze Actress」（冰冻女优）", "凍符「フリーズアクトレス」", THSpell.Hard | THSpell.Lunatic),
            ...
            new THSpell(this, chara_爱丽丝_玛格特洛依德, "雅符「春之京人偶」", "雅符「春の京人形」", THSpell.Lunatic),
            ...
            new THSpell(this, chara_魂魄妖梦, "天上剑「天人亦五衰」", "天上剣「天人の五衰」", THSpell.Easy | THSpell.Normal),
            ...
            new THSpell(this, chara_西行寺幽幽子, "华灵「Ghost Butterfly」（死蝶）", "華霊「ゴーストバタフライ」", THSpell.Easy, "华灵「死蝶」"),
            new THSpell(this, chara_西行寺幽幽子, "华灵「Swallowtail Butterfly」（燕尾蝶）", "華霊「スワローテイルバタフライ」", THSpell.Normal),
            new THSpell(this, chara_西行寺幽幽子, "华灵「Deep-Rooted Butterfly」（深固难徙之蝶）", "華霊「ディープルーティドバタフライ」", THSpell.Hard, "华灵「深固难徙之蝶」"),
            new THSpell(this, chara_西行寺幽幽子, "华灵「Butterfly Delusion」（蝶幻）", "華霊「バタフライディルージョン」", THSpell.Lunatic, "华灵「蝶幻」"),
            ...
            new THSpell(this, chara_八云蓝, "式辉「狐狸妖怪镭射」", "式輝「狐狸妖怪レーザー」", THSpell.Extra),
            new THSpell(this, chara_八云蓝, "式辉「充满魅力的四面楚歌」", "式輝「四面楚歌チャーミング」", THSpell.Extra),
            new THSpell(this, chara_八云蓝, "式辉「天狐公主 -Illusion-」", "式輝「プリンセス天狐 -Illusion-」", THSpell.Extra),
            new THSpell(this, chara_八云蓝, "式弹「Ultimate Buddhist」（最后的佛教徒）", "式弾「アルティメットブディスト」", THSpell.Extra),
            new THSpell(this, chara_八云蓝, "式弹「Unilateral Contact」（片面义务契约）", "式弾「ユーニラタルコンタクト」", THSpell.Extra),
            new THSpell(this, chara_八云蓝, "式神「橙」", "式神「橙」", THSpell.Extra),
            new THSpell(this, chara_八云蓝, "「狐狗狸的契约」", "「狐狗狸さんの契約」", THSpell.Extra, "「狐狗狸的契约」"),
            ...
            new THSpell(this, chara_八云紫, "结界「梦与现实的法咒」", "結界「夢と現の呪」", THSpell.Phantasm),
            new THSpell(this, chara_八云紫, "结界「动与静的均衡」", "結界「動と静の均衡」", THSpell.Phantasm),
            new THSpell(this, chara_八云紫, "结界「光与暗的网孔」", "結界「光と闇の網目」", THSpell.Phantasm),
            new THSpell(this, chara_八云紫, "罔两「直与曲的梦乡」", "罔両「ストレートとカーブの夢郷」", THSpell.Phantasm),
            ...
            new THSpell(this, chara_八云紫, "「人与妖的境界」", "「人間と妖怪の境界」", THSpell.Phantasm),
