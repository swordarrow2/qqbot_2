...
public class TH15Data extends THGameData {
    ...
    private TH15Data() {
        ...
        spells = new THSpell[]{
            ...
            new THSpell(this, chara_铃瑚, "月见「September Fullmoon」（九月的满月）", "月見「セプテンバーフルムーン」", THSpell.Easy | THSpell.Normal | THSpell.Hard),
            new THSpell(this, chara_铃瑚, "月见酒「Lunatic September」（月狂的九月）", "月見酒「ルナティックセプテンバー」", THSpell.Lunatic),
            ...
            new THSpell(this, chara_纯狐, "「纯粹的疯狂」", "「純粋なる狂気」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
