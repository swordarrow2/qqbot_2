...
public class TH08Data extends THGameData {
    ...
    private TH08Data() {
        ...
        spells = new THSpell[]{
            ...
            new THSpell(this, chara_雾雨魔理沙, "光击「Shoot the Moon」（击月）", "光撃「シュート・ザ・ムーン」", THSpell.Hard | THSpell.Lunatic),
            ...
            new THSpell(this, chara_八意永琳, "神脑「Omoikane Brain」（思兼的智慧）", "神脳「オモイカネブレイン」", THSpell.Hard | THSpell.Lunatic),
            ...
            new THSpell(this, chara_蓬莱山辉夜, "难题「火鼠的皮衣　-焦躁的内心-」", "難題「火鼠の皮衣　-焦れぬ心-」", THSpell.Easy | THSpell.Normal),
            ...
            new THSpell(this, chara_蓬莱山辉夜, "「永夜归返　-耀世的启明星-」", "「永夜返し　-明けの明星-」", THSpell.Hard | THSpell.LastSpell),
            new THSpell(this, chara_蓬莱山辉夜, "「永夜归返　-光明之世-」", "「永夜返し　-世明け-」", THSpell.Lunatic | THSpell.LastSpell),
            ...
            new THSpell(this, chara_藤原妹红, "虚人「无一」", "虚人「ウー」", THSpell.Extra),
            ...
            new THSpell(this, chara_上白泽慧音, "「日出之国的天子」", "「日出づる国の天子」", THSpell.LastWord),
            new THSpell(this, chara_上白泽慧音, "「似有似无的净化」", "「無何有浄化」", THSpell.LastWord),
            new THSpell(this, chara_因幡帝, "「Ancient Duper」（远古的骗术）", "「エンシェントデューパー」", THSpell.LastWord, "「远古的骗术」"),
            new THSpell(this, chara_铃仙_优昙华院_因幡, "「幻胧月睨(Lunatic Red Eyes)」（月的红眼）", "「幻朧月睨（ルナティックレッドアイズ）」　", THSpell.LastWord),
            ...
            new THSpell(this, chara_爱丽丝_玛格特洛依德, "「猎奇剧团的怪人」", "「グランギニョル座の怪人」", THSpell.LastWord),
            new THSpell(this, chara_蕾米莉亚_斯卡蕾特, "「Scarlet Destiny」（绯色的命运）", "「スカーレットディスティニー」", THSpell.LastWord, "「绯红的宿命」"),
