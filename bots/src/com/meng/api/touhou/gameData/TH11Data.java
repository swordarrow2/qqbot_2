package com.meng.api.touhou.gameData;

import com.meng.api.touhou.THCharacter;
import com.meng.api.touhou.THGameData;
import com.meng.api.touhou.THMusic;
import com.meng.api.touhou.THPlayer;
...
public class TH11Data extends THGameData {
    ...
    private TH11Data() {
        ...
        spells = new THSpell[]{
            ...
            new THSpell(this, chara_古明地觉, "想起「Terrible Souvenir」（恐怖的回忆）", "想起「テリブルスーヴニール」", THSpell.Easy | THSpell.Normal),
            new THSpell(this, chara_古明地觉, "想起「恐怖催眠术」", "想起「恐怖催眠術」　", THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「二重黑死蝶」", "想起「二重黒死蝶」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「飞行虫之巢」", "想起「飛行虫ネスト」　", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「波与粒的境界」", "想起「波と粒の境界」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「户隐山之投」", "想起「戸隠山投げ」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「百万鬼夜行」", "想起「百万鬼夜行」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「蒙蒙迷雾」", "想起「濛々迷霧」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「风神木叶隐身术」", "想起「風神木の葉隠れ」　", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「天狗巨暴流」", "想起「天狗のマクロバースト」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「鸟居旋风」", "想起「鳥居つむじ風」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「春之京人偶」", "想起「春の京人形」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「Straw Doll Kamikaze」（稻草人偶敢死队）", "想起「ストロードールカミカゼ」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「Return Inanimateness」（回归虚无）", "想起「リターンイナニメトネス」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「Mercury Poison」（水银之毒）", "想起「マーキュリポイズン」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「Princess Undine」（水精公主）", "想起「プリンセスウンディネ」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「贤者之石」", "想起「賢者の石」　", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「延展手臂」", "想起「のびーるアーム」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「河童之河口浪潮」", "想起「河童のポロロッカ」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_古明地觉, "想起「粼粼水底之心伤」", "想起「光り輝く水底のトラウマ」", THSpell.Easy | THSpell.Normal | THSpell.Hard | THSpell.Lunatic),
            ...
            new THSpell(this, chara_灵乌路空, "「Hell's Tokamak」（地狱的托卡马克）", "「ヘルズトカマク」", THSpell.Hard | THSpell.Lunatic),
            new THSpell(this, chara_灵乌路空, "「地狱的人工太阳」", "「地獄の人工太陽」", THSpell.Easy | THSpell.Normal),
            ...
            new THSpell(this, chara_古明地恋, "表象「先祖托梦」", "表象「夢枕にご先祖総立ち」", THSpell.Extra),
            ...
            new THSpell(this, chara_古明地恋, "反应「妖怪测谎仪」", "反応「妖怪ポリグラフ」", THSpell.Extra),
            new THSpell(this, chara_古明地恋, "无意识「弹幕的墨迹检测」", "無意識「弾幕のロールシャッハ」", THSpell.Extra),
            new THSpell(this, chara_古明地恋, "复燃「恋之埋火」", "復燃「恋の埋火」", THSpell.Extra),
