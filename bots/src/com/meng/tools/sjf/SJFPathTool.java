...
public class SJFPathTool {
    ...
    public static File getPersistentPath(String fileName) {
        return new File(getPersistentPath() + fileName);
    }

    public static String getAudioPath() {
        return getAppDirectory() + "/audio/";
    }

    public static File getAudioPath(String fileName) {
    ...
    public static File getAvatarPath(String fileName) {
        return new File(getAvatarPath() + fileName);
    }
    ...
    public static String getTempPath() {
        return getAppDirectory() + "/temp/";
    }

    public static File getTempPath(String fileName) {
        return new File(getTempPath() + fileName);
    }
