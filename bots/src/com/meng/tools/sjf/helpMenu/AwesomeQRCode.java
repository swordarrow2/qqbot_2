...
//     */
//    public static BufferedImage create(String contents, int size, int margin, float dataDotScale, int colorDark,
//                                       int colorLight, BufferedImage backgroundImage, boolean whiteMargin, boolean autoColor,
//                                       boolean binarize, int binarizeThreshold, boolean roundedDataDots,
//                                       BufferedImage logoImage, int logoMargin, int logoCornerRadius, float logoScale) throws IllegalArgumentException {
//        if (contents.isEmpty()) {
...
//    }
//
//    private static BufferedImage render(ByteMatrix byteMatrix, int innerRenderedSize, int margin, float dataDotScale,
//                                 int colorDark, int colorLight, BufferedImage backgroundImage, boolean whiteMargin,
//                                 boolean autoColor, boolean binarize, int binarizeThreshold, boolean roundedDataDots,
//                                        BufferedImage logoImage, int logoMargin, int logoCornerRadius, float logoScale) {
//        int nCount = byteMatrix.getWidth();
//        float nWidth = (float) innerRenderedSize / nCount;
//        float nHeight = (float) innerRenderedSize / nCount;
//
//        BufferedImage backgroundImageScaled = Bitmap.createBitmap(
