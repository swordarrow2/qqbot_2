...
public class FileFormat {
    private static HashSet<Content> hashset = new HashSet<Content>(){
        {
        ...
        private void add(String bytes, String extendName, FileType describe) {
             add(new Content(bytes, extendName, describe));
        }
    };
